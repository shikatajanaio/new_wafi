...
const headers = [
    { text: 'KODE TRANSAKSI', value: 'kode_transaksi', sortable: true },
    ...
    { text: 'TANGGAL', value: 'tgl', sortable: true },
...
const fetchDataFromAPI = async () => {
    try {
        ...
        const response = await fetch('https://paymentbe.citra-nusantara.or.id/api/produk/riwayat/penjualan');
