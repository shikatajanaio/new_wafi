...
const headers = [
    { text: 'NO WALLET', value: 'wallet_number' },
...
const searchField = ref('wallet_number');
// Fungsi untuk mengambil data dari API
const fetchDataFromAPI = async () => {
    try {
        // Gantilah URL API sesuai dengan URL API yang Anda gunakan
        const response = await fetch('https://payment.citra-nusantara.or.id/be/wallet/profile');
        ...
        <div class="col-12">
            <div class="card">
                <span class="p-float-label">
                    ...
                    <label for="inputtext">Cari Berdasarkan Nomor E-Wallet disini</label>
                </span>
                <p></p>
