...
const headers = [
    { text: 'KODE CABANG', value: 'kode_cabang' },
    { text: 'NAMA CABANG', value: 'nama_cabang' },
    { text: 'LOKASI CABANG', value: 'lokasi_cabang' },
...
const fetchDataFromAPI = async () => {
    try {
        ...
        const response = await fetch('https://paymentbe.citra-nusantara.or.id/api/cabang');
...
<template>
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <Button label="Cabang Baru" @click="tambah" class="p-button-outlined mr-2 mb-2" style="margin-top: 2px" />
                <h5>satuan</h5>
