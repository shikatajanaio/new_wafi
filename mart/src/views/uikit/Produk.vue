...
const fetchDataFromAPI = async () => {
    try {
        ...
        const response = await fetch('https://paymentbe.citra-nusantara.or.id/api/produk');
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <p></p>
                <a href="/#/home/tambah_produk" class="btn btn-primary" style="margin-top: 2px"> Tambah Produk </a>

                <h5>produk</h5>

                <EasyDataTable :headers="headers" :items="items" show-index :search-field="searchField" :search-value="searchValue">
                    <template #item-operation="item">
                        <div class="operation-wrapper">
                            <Button icon="pi pi-pencil" class="p-button-rounded p-button-warning p-button-text mr-2 mb-2" @click="edit_produk(item)" />

                            <Button icon="pi pi-times" class="p-button-rounded p-button-danger p-button-text mr-2 mb-2" @click="hapus_produk(item)" />
                        </div>
                    </template>
                </EasyDataTable>
            </div>
