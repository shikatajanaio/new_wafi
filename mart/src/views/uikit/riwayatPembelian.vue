...
const headers = [
    { text: 'KODE TRANSAKSI', value: 'cabang', sortable: true },
    { text: 'NAMA PRODUK', value: 'nama', sortable: true },
    { text: 'JUMLAH', value: 'jumlah', sortable: true },
    { text: 'HARGA POKOK', value: 'harga_pokok', sortable: true }
];
...
const fetchDataFromAPI = async () => {
    try {
        ...
        const response = await fetch('https://paymentbe.citra-nusantara.or.id/api/produk/riwayat/pembelian');
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <EasyDataTable :headers="headers" :items="items" show-index> </EasyDataTable>
            </div>
        </div>
    </div>
</template>
