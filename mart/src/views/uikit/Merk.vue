...
const headers = [
  { text: "NAMA MEREK", value: "nama_merk" },
...
const simpan_tambah = async () => {
    const response = await fetch('https://paymentbe.citra-nusantara.or.id/api/merk/tambah', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json', // Sesuaikan dengan jenis konten yang digunakan oleh API Anda
      },
      body: JSON.stringify({
        nama_merk : nama_merk_baru.value
      }),
    });
    const data = await response.json();
    items.value = data
...
const hapus = async (item) => {
    const response = await fetch('https://paymentbe.citra-nusantara.or.id/api/merk/hapus', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json', // Sesuaikan dengan jenis konten yang digunakan oleh API Anda
      },
...
const simpan_edit = async () => {
    console.log(nama_merk_baru.value)
    item_edit.value.nama_merk = nama_merk_baru.value
    console.log(item_edit.value)
    const response = await fetch('https://paymentbe.citra-nusantara.or.id/api/merk/edit', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json', // Sesuaikan dengan jenis konten yang digunakan oleh API Anda
      },
...
<template>
    <div v-if="tampilkanEdit">
        ...
        <div class="col-12">
            <div class="card">
        <h5>Edit Nama Merk {{ item_edit.nama_merk }}</h5>
        <div class="p-fluid formgrid"> 
                <div class="field">
                    <label for="name3" class="col-12 mb-2 md:col-2 md:mb-0" >Nama Merk Baru:</label>
                    <InputText id="nama_merk" v-model="nama_merk_baru" type="text" :placeholder="item_edit.nama_merk" /><br/><br/>
    ...
    <div v-if="tampilkanTambah">
        ...
        <div class="col-12">
            <div class="card">
        <h5>Tambahkan Merk</h5>
        <div class="p-fluid formgrid"> 
                <div class="field">
                    <label for="name3" class="col-12 mb-12 md:col-12 md:mb-0" >Nama merk Baru:</label>
                    <InputText id="nama_merk" v-model="nama_merk_baru" type="text" :placeholder="item_edit.nama_merk" /><br/><br/>
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <Button label="Merk Baru" @click="tambah" class="p-button-outlined mr-2 mb-2" style="margin-top: 2px;"/>
                <h5>Merk</h5>
